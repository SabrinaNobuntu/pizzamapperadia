...
export class ListPedidoComponent implements AfterViewInit,  OnDestroy  {
  ...
  userConfig; 
  searchableFields = [] 
  //apiURL: string = environment.PedidoAPIPath;//Campo que é alterável, o nome do campo "variations"+"APIPATH". 
