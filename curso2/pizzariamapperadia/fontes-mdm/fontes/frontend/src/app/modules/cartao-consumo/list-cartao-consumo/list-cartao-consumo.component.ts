...
export class ListCartaoConsumoComponent implements AfterViewInit,  OnDestroy  {
  ...
  userConfig; 
  searchableFields = [] 
  //apiURL: string = environment.CartaoConsumoAPIPath;//Campo que é alterável, o nome do campo "variations"+"APIPATH". 
