...
@Component({
  selector: 'app-details-tipo-pagamento',
  templateUrl: './tipo-pagamento-form.component.html',
  styleUrls: ['./tipo-pagamento-form.component.scss']
})
export class TipoPagamentoFormComponent extends BaseResourceFormComponent<TipoPagamento> implements AfterViewInit, OnDestroy { 


  JSONPath : string = environment.tipoPagamentoJSONPath; 
...
//  private ngUnsubscribe = new Subject(); 
  ...
  constructor(
    protected tipoPagamentoService: TipoPagamentoService,//Linha alterável com base na classe 
    protected injector: Injector, 
    private generatedFormFactoryService: GeneratedFormFactoryService, 
    private formGeneratorService: FormGeneratorService 
  ) { 
    super(injector, new TipoPagamento(), tipoPagamentoService, TipoPagamento.fromJson);//Linha alterável com base na classe 
