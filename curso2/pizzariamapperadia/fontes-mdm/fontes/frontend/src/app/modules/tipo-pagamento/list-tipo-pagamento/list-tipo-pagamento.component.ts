...
export class ListTipoPagamentoComponent implements AfterViewInit,  OnDestroy  {
  ...
  userConfig; 
  searchableFields = [] 
  //apiURL: string = environment.TipoPagamentoAPIPath;//Campo que é alterável, o nome do campo "variations"+"APIPATH". 
