...
export class ListCadastroClienteComponent implements AfterViewInit,  OnDestroy  {
  ...
  userConfig; 
  searchableFields = [] 
  //apiURL: string = environment.CadastroClienteAPIPath;//Campo que é alterável, o nome do campo "variations"+"APIPATH". 
