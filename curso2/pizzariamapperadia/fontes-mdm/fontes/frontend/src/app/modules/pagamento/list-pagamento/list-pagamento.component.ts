...
export class ListPagamentoComponent implements AfterViewInit,  OnDestroy  {
  ...
  userConfig; 
  searchableFields = [] 
  //apiURL: string = environment.PagamentoAPIPath;//Campo que é alterável, o nome do campo "variations"+"APIPATH". 
