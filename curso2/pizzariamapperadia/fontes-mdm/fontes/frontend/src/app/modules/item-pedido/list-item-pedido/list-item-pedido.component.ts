...
export class ListItemPedidoComponent implements AfterViewInit,  OnDestroy  {
  ...
  userConfig; 
  searchableFields = [] 
  //apiURL: string = environment.ItemPedidoAPIPath;//Campo que é alterável, o nome do campo "variations"+"APIPATH". 
