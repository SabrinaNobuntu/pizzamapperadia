...
export class ListCategoriaComponent implements AfterViewInit,  OnDestroy  {
  ...
  userConfig; 
  searchableFields = [] 
  //apiURL: string = environment.CategoriaAPIPath;//Campo que é alterável, o nome do campo "variations"+"APIPATH". 
