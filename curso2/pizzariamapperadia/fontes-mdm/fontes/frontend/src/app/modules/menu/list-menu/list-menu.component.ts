...
export class ListMenuComponent implements AfterViewInit,  OnDestroy  {
  ...
  userConfig; 
  searchableFields = [] 
  //apiURL: string = environment.MenuAPIPath;//Campo que é alterável, o nome do campo "variations"+"APIPATH". 
