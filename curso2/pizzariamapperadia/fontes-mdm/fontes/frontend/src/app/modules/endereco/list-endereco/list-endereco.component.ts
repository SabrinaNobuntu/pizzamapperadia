...
export class ListEnderecoComponent implements AfterViewInit,  OnDestroy  {
  ...
  userConfig; 
  searchableFields = [] 
  //apiURL: string = environment.EnderecoAPIPath;//Campo que é alterável, o nome do campo "variations"+"APIPATH". 
