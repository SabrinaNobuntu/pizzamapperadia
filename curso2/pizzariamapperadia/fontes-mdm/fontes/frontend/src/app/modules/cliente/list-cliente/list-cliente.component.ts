...
export class ListClienteComponent implements AfterViewInit,  OnDestroy  {
  ...
  userConfig; 
  searchableFields = [] 
  //apiURL: string = environment.ClienteAPIPath;//Campo que é alterável, o nome do campo "variations"+"APIPATH". 
