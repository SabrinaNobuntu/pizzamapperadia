...
export class MenuFormComponent extends BaseResourceFormComponent<Menu> implements AfterViewInit, OnDestroy { 


  JSONPath : string = environment.menuJSONPath; 
...
//  private ngUnsubscribe = new Subject(); 
  ...
  constructor(
    protected menuService: MenuService,//Linha alterável com base na classe 
    protected injector: Injector, 
    private generatedFormFactoryService: GeneratedFormFactoryService, 
    private formGeneratorService: FormGeneratorService 
  ) { 
    super(injector, new Menu(), menuService, Menu.fromJson);//Linha alterável com base na classe 
