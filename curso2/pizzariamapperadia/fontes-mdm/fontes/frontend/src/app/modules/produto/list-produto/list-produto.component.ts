...
export class ListProdutoComponent implements AfterViewInit,  OnDestroy  {
  ...
  userConfig; 
  searchableFields = [] 
  //apiURL: string = environment.ProdutoAPIPath;//Campo que é alterável, o nome do campo "variations"+"APIPATH". 
