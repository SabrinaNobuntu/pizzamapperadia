...
export class ProdutoFormComponent extends BaseResourceFormComponent<Produto> implements AfterViewInit, OnDestroy { 


  JSONPath : string = environment.produtoJSONPath; 
...
//  private ngUnsubscribe = new Subject(); 
  ...
  constructor(
    protected produtoService: ProdutoService,//Linha alterável com base na classe 
    protected injector: Injector, 
    private generatedFormFactoryService: GeneratedFormFactoryService, 
    private formGeneratorService: FormGeneratorService 
  ) { 
    super(injector, new Produto(), produtoService, Produto.fromJson);//Linha alterável com base na classe 
