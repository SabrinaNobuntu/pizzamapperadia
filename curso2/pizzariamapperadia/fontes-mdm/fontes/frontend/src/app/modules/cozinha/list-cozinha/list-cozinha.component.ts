...
export class ListCozinhaComponent implements AfterViewInit,  OnDestroy  {
  ...
  userConfig; 
  searchableFields = [] 
  //apiURL: string = environment.CozinhaAPIPath;//Campo que é alterável, o nome do campo "variations"+"APIPATH". 
