...
export class ListGarconComponent implements AfterViewInit,  OnDestroy  {
  ...
  userConfig; 
  searchableFields = [] 
  //apiURL: string = environment.GarconAPIPath;//Campo que é alterável, o nome do campo "variations"+"APIPATH". 
