...
import { CadastroClienteService } from "../shared/cadastro-cliente.service"; 
...
@Component({
  selector: 'app-details-cadastro-cliente',
  templateUrl: './cadastro-cliente-form.component.html',
  styleUrls: ['./cadastro-cliente-form.component.scss']
})
export class CadastroClienteFormComponent extends BaseResourceFormComponent<CadastroCliente> implements AfterViewInit, OnDestroy { 


  JSONPath : string = environment.cadastroClienteJSONPath; 
...
//  private ngUnsubscribe = new Subject(); 
  ...
  constructor(
    protected cadastroClienteService: CadastroClienteService,//Linha alterável com base na classe 
    protected injector: Injector, 
    private generatedFormFactoryService: GeneratedFormFactoryService, 
    private formGeneratorService: FormGeneratorService 
  ) { 
    super(injector, new CadastroCliente(), cadastroClienteService, CadastroCliente.fromJson);//Linha alterável com base na classe 
